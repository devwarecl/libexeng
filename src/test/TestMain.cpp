...
SUITE(HyperBoxTestSuite)
{
    TEST_FIXTURE(HyperBoxFixture, HyperBoxTestFixture)
    {
...
SUITE(TestVectorSuite)
{
    TEST_FIXTURE(VectorFixture, TestVectorFixtureOperators)
    {
